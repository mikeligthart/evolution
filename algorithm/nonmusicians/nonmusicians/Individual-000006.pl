...
sub add_to_loop {
  ...
  if ('tune') {
    my $sound = q[wah(asynth(0.25, $n[$note % @n], $len, $spc,  mseries([4, 0.5167, 0.5926, 3, 0.7448, 6*4*2, 6, 4, -(2/3), 1/2], 1, 6, 0.2817), [4, 0.5167, 0.5926, 3, 0.7448, 6*4*2, 6, 4, -(2/3), 1/2], [1, 0.3476, 0.4994, 0, 0.03956, 1, (1+1), 3, 2, 1]),0.8367*(5),0.6388*0.02978,0.75)];
