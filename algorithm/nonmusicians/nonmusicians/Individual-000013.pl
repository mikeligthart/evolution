...
$l = offset($l,2*4*4+1*4+3);
  ...
  if ('sequencer') {
    my $sound = q[wah(asynth(0.25, $n[$note % @n], $len, $spc,  mseries([4, 0.5167, 0.5926, 3, 0.7448, 6*4*2, 6, 4, -(2/3), 1/2], 1, 6, 0.2817), [4, 0.5167, 0.5926, 3, 0.7448, 6*4*2, 6, 4, -(2/3), 1/2],  mseries([3, 0.7311, 0.5938, 0, 0.5398, 2, 7, 1, -(3/4), 1/2], 2, 7, 0.8352),  mseries([4, 0.5167, 0.5926, 3, 0.7448, 6*4*2, 6, 4, -(2/3), 1/2], 1, 6, 0.2817)),0.8367*(5),0.6388*0.02978,0.75)];
