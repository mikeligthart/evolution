...
class User 
{
	...
	function __construct($user,$display,$pass,$email,$instrument,$regular,$lessons)
	{
		...
		if($this->playinstrument && $this->playregular && $this->musiclesson)
		{
			$this->musician = 1;
		}
